...
<head>
    ...
    <style>
        ...
        .kop { border-bottom: 2px solid #111827; padding-bottom: 10px; margin-bottom: 18px; }
        ...
        .clinic-name { font-size: 17px; font-weight: 700; letter-spacing: .5px; }
        .address { font-size: 9px; color: #4b5563; }
        h1 { margin: 0 0 14px; font-size: 15px; text-align: center; text-transform: uppercase; }
        .meta td { padding: 3px 0; vertical-align: top; }
        .meta .label { width: 115px; color: #6b7280; }
        table.items { width: 100%; border-collapse: collapse; margin-top: 15px; }
        .items th { background: #f3f4f6; border: 1px solid #d1d5db; padding: 7px; text-align: left; font-size: 9px; }
